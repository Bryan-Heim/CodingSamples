...
public interface FileClientInterface {
     ...
     *
     */
    public boolean upload(final String sourceFile, final String destFile, final String group, final UserToken token, Hashtable kcTable, Hashtable intTable);
     ...
     *
     */
    public boolean download(final String sourceFile, final String destFile, final UserToken token, Hashtable kcTable, Hashtable intTable);
