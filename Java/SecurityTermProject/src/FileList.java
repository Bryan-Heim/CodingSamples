...
public class FileList implements java.io.Serializable {
    ...
    public synchronized void addFile(String owner, String group, String path, int keyNumber, ArrayList<String> IVList, String HMAC) {
        ShareFile newFile = new ShareFile(owner, group, path, keyNumber, IVList, HMAC);
        list.add(newFile);
    }
