...
<pre>
<b>
Now Showing All Tickets From Single Sender.
</b>
<hr>
</pre>
<form action="selectedchoice.php" method="post">
<?php
$sent_name = $_SESSION['sent_name'];
$myconnection = new mysqli("localhost", "root", "", "Project2");
$query = "SELECT * FROM tickets WHERE sname='$sent_name' ORDER BY $sortby ASC";
...
{
    echo "Currently, there are no other tickets opened!";
}
?>
</br>
